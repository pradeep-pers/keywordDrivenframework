...
public class SMSCListener extends SmppObject implements Runnable
{
    ...
    throws IOException
    {
        ...
        System.out.println("going to start SMSCListener on port "+port);
        if (!isReceiving) {
            ...
            if (asynchronous) {
                ...
                System.out.println("starting listener in separate thread.");
                Thread serverThread = new Thread(this);
                serverThread.start();
                debug.write("listener started in separate thread.");
                System.out.println("listener started in separate thread.");
            } else {
                debug.write("going to listen in the context of current thread.");
                System.out.println("going to listen in the context of current thread.");
                run();
            }
        } else {
